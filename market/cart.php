...
<body class="bg-gray-900">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    <?php if(isset($_SESSION['is_login'])): ?>
                        <div class="relative">
                            <button id="dropdownToggle" class="flex items-center space-x-2 text-white focus:outline-none">
                                <img src="<?php echo $_SESSION['profile_image'] ?? '../assets/default-avatar.png'; ?>" 
                                    class="w-8 h-8 rounded-full">
                                <span><?php echo $_SESSION['full_name']; ?></span>
                            </button>
                            <div id="dropdownMenu" class="absolute right-0 w-48 py-2 mt-2 bg-gray-800 rounded-lg shadow-xl hidden">
    ...
    <script>
        ...
        // Optional: close the dropdown if click outside
