...
if (isset($_GET['code'])) {
    try {
        ...
        if (isset($token['error'])) {
            throw new Exception('Error getting access token: ' . $token['error_description']);
        }
        ...
        $_SESSION['oauth_error'] = "Terjadi kesalahan saat login dengan Google. Silakan coba lagi.";
